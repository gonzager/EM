...
Begin VB.Form frmConceptoCpasABM 
   Caption         =   "Conceptos de Compras"
   ClientHeight    =   6930
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   7770
   ...
   End
End
Attribute VB_Name = "frmConceptoCpasABM"
...
Dim ltConcepto As tConceptos
    ...
    If Me.txtCodigo.Text <> "" Then
        ...
        If ltConcepto.codigo <> "" Then
            If operacion = "A" Then
                If Concepto.insertConcepto(ltConcepto, "COMPRAS") > 0 Then
            ...
            ElseIf operacion = "M" Then
                If Concepto.updateConcepto(ltConcepto, "COMPRAS") > 0 Then
...
Private Sub cargarGrilla()
    ...
    ls_sql = "SELECT CODIGO, DESCRIPCION, DEFECTO, VISIBLE FROM CONCEPTOCPA "
...
Private Sub habilitarOperacion(ls_operacion As String)
    ...
    If ls_operacion = "A" Then
        Me.frmDatos.Enabled = True
        Me.txtCodigo.Text = fMaxCodigo("COMPRAS")
...
Private Sub cargarRegistroAModificar(codigo As String)
    ...
    ls_sql = "SELECT CODIGO, DESCRIPCION, DEFECTO, VISIBLE FROM CONCEPTOCPA  WHERE CODIGO = '" & codigo & "'"
